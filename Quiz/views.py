...
def artist(request):
    ...
    try:
        ...
        results = musicbrainzngs.get_artist_by_id('69ee3720-a7cb-4402-b48d-a02c366f2bcf', includes=["release-groups"],
    ...
    for release_group in results["artist"]["release-group-list"]:
        ...
        new_album.image_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Album_cover_with_notes_03" \
                              ".svg/240px-Album_cover_with_notes_03.svg.png "
    ...
    try:
        ...
        image_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Album_cover_with_notes_03.svg/240px" \
                    "-Album_cover_with_notes_03.svg.png "
    return render(request, 'Quiz/artist.html',
                  {'albums': albums, 'artist': artist, 'image': image_url, 'empty': isEmpty, 'error': error})
...
def quiz(request):
    ...
    try:
        ...
        release = musicbrainzngs.get_release_by_id("a1170afd-e95f-3975-ad26-e04c70d6a42b",
    ...
    return render(request, 'Quiz/quiz.html',
                  {'tracks': json_tracks, 'cover': image_url, 'title': title, 'artist': artist, 'discs': discInfoString,
                   'album_id': query, 'error': error})
...
def get_release_from_release_group(release_group):
    ...
    release = musicbrainzngs.get_release_by_id(release_group['release-group']['release-list'][release_index]['id'],
                                               includes=['recordings', 'artists'])
    return release
